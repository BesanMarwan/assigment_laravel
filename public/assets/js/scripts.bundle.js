			...
			paging: function(meta, callback) {
				var pg = {
					...
					init: function(meta) {
						...
						// always recount total users
						pg.meta.pages = Math.max(Math.ceil(pg.meta.total / pg.meta.perpage), 1);

						// current page must be not over than total users
					...
					populate: function() {
						...
						var pagesNumber = Plugin.getOption('toolbar.items.pagination.users.desktop.pagesNumber');
					...
					pagingBreakpoint: function() {
						...
						// pagination update
						$.each(Plugin.getOption('toolbar.items.pagination.users'),
		...
		toolbar: {
			...
			items: {
				...
				pagination: {
					...
					// number of users to display by breakpoints
					pages: {
						desktop: {
							layout: 'default',
							pagesNumber: 5,
