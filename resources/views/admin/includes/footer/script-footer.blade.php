...
<!--end::Page Scripts-->
<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>s
...
<script src="{{asset('assets/js/jquery.multifield.min.js')}}" type="text/javascript"></script>
@toastr_js
@toastr_render
@stack('scripts')
